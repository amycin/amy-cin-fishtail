...
The Teardrop Pulse, pink-noise ticker, tempo-lattice conductor, and analogue CV WAV package are Amy McBride / amy_cin's Fishtail sound-design material.
...
- The Teardrop Pulse, pink-noise ticker, tempo-lattice conductor, and analogue CV WAV package are implemented with browser-native Web Audio, Standard MIDI, PCM, and ZIP logic; no third-party audio engine is bundled.
