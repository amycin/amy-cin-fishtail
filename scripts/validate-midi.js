...
function runFugueTests() {
  ...
  const timelineUiOk = indexHtml.includes('class="form-timeline-shell"')
    ...
    && indexHtml.includes('<details class="export-drawer">')
    ...
    && indexHtml.includes('id="generateButton" type="button">Generate</button>')
    ...
    && appJs.includes("Open Exports to save MIDI")
  ...
  const probePitchSliderOk = indexHtml.includes('id="probePitchInput" type="range" min="0" max="83" step="1" value="45"')
    && indexHtml.includes('href="styles.css?v=78"')
    ...
    && indexHtml.includes('src/app.js?v=120')
